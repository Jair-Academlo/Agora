...
function App() {
	...
	const channel = useRef('prueba 2');
	// you can apply appid follow the guide https://www.agora.io/en/blog/how-to-get-started-with-agora/
	const appid = useRef('22ad9cbff29c4315b61d6d67aa16388e');
	// you can apply token follow the guide https://www.agora.io/en/blog/how-to-get-started-with-agora/
	const token = useRef(
		'007eJxTYLjYbr9hmJa+ca4B7HWCTft5n2Ycfnw1vfpU2t6TP84MK1QYDAySkyxTE5KSzOyTDYxNjRNMjNMMUsxM09MNDQztrBIvaghlNoQyMgQ4hHNzMgAgSA+B0NBUWlqUqKCEQMDAFpWIYg='
	);
